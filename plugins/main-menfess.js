...
let ssn = `〠 Dᴀʀɪ : ${name}\n⎙ Pᴇsᴀɴ : ${pesan}`
        ...
        //Created By AL? Offc
       await conn.sendButtonDoc(data.jid, tek, ssn, 'Y', 'Y', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/rellcuy7',
    ...
    mediaUrl: 'https://facebook.com/rellcuy7',
    containsAutoReply: false,
    mediaType: 1,
    renderLargerThumbnail: false, 
    description: sgc,
